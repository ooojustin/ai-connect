...
//!
//! This crate simplifies authentication with AI providers using secure public-client OAuth flows.
//! Supports Anthropic, OpenAI, and can be extended to other providers via the `OAuthProvider` trait.
...
pub use error::{CallbackError, OAuthError};
#[cfg(feature = "local-server")]
